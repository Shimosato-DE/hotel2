...
public class ReservationController {
	...
	public String input(@PathVariable(name = "id") Integer id, @Validated @ModelAttribute ReservationInputForm reservationInputForm, BindingResult result, RedirectAttributes redirectAttributes, Model model ) {
